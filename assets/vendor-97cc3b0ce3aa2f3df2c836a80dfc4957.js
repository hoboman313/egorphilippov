...
var x=function(e){var t,n,r,i,o,s,a,u,l,c,p,h,f,d,m,g,y,v,b,_="sizzle"+1*new Date,w=e.document,E=0,x=0,C=se(),T=se(),S=se(),k=function(e,t){return e===t&&(p=!0),0},R={}.hasOwnProperty,O=[],A=O.pop,P=O.push,N=O.push,j=O.slice,M=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
return-1},D="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",L="[\\x20\\t\\r\\n\\f]",I="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",q="\\["+L+"*("+I+")(?:"+L+"*([*^$|!~]?=)"+L+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+L+"*\\]",F=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+q+")*)|.*)\\)|)",B=new RegExp(L+"+","g"),H=new RegExp("^"+L+"+|((?:^|[^\\\\])(?:\\\\.)*)"+L+"+$","g"),z=new RegExp("^"+L+"*,"+L+"*"),V=new RegExp("^"+L+"*([>+~]|"+L+")"+L+"*"),U=new RegExp("="+L+"*([^\\]'\"]*?)"+L+"*\\]","g"),W=new RegExp(F),G=new RegExp("^"+I+"$"),Y={ID:new RegExp("^#("+I+")"),CLASS:new RegExp("^\\.("+I+")"),TAG:new RegExp("^("+I+"|[*])"),ATTR:new RegExp("^"+q),PSEUDO:new RegExp("^"+F),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+L+"*(even|odd|(([+-]|)(\\d*)n|)"+L+"*(?:([+-]|)"+L+"*(\\d+)|))"+L+"*\\)|)","i"),bool:new RegExp("^(?:"+D+")$","i"),needsContext:new RegExp("^"+L+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+L+"*((?:-\\d)?\\d*)"+L+"*\\)|)(?=[^-]|$)","i")},$=/^(?:input|select|textarea|button)$/i,Q=/^h\d$/i,K=/^[^{]+\{\s*\[native \w/,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,J=/[+~]/,Z=new RegExp("\\\\([\\da-f]{1,6}"+L+"?|("+L+")|.)","ig"),ee=function(e,t,n){var r="0x"+t-65536
...
try{N.apply(O=j.call(w.childNodes),w.childNodes),O[w.childNodes.length].nodeType}catch(xe){N={apply:O.length?function(e,t){P.apply(e,j.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function oe(e,t,r,i){var o,a,l,c,p,d,y,v=t&&t.ownerDocument,E=t?t.nodeType:9
...
if(!a){for(t||(t=s(e)),n=t.length;n--;)(a=Ee(t[n]))[_]?i.push(a):o.push(a);(a=S(e,function(e,t){var n=t.length>0,i=e.length>0,o=function(o,s,a,u,c){var p,d,g,y=0,v="0",b=o&&[],_=[],w=l,x=o||i&&r.find.TAG("*",c),C=E+=null==w?1:Math.random()||.1,T=x.length
...
var ke=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,Re=/<script|<style|<link/i,Oe=/checked\s*(?:[^=]|=\s*.checked.)/i,Ae=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
...
if(u)for(c=a[a.length-1].ownerDocument,_.map(a,je),p=0;p<u;p++)l=a[p],pe.test(l.type||"")&&!Q.access(l,"globalEval")&&_.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?_._evalUrl&&_._evalUrl(l.src):v(l.textContent.replace(Ae,""),c,l))}return e}function Le(e,t,n){for(var r,i=t?_.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||_.cleanData(fe(r)),r.parentNode&&(n&&_.contains(r.ownerDocument,r)&&de(fe(r,"script")),r.parentNode.removeChild(r))
...
try{l.href=d.url,l.href=l.href,d.crossDomain=Dt.protocol+"//"+Dt.host!=l.protocol+"//"+l.host}catch(S){d.crossDomain=!0}}if(d.data&&d.processData&&"string"!=typeof d.data&&(d.data=_.param(d.data,d.traditional)),It(Nt,d,n,C),c)return C
...
this.blocks=t,this.inlines=n},e.LazyCompiler=A,e.compile=_,e.AbstractCompiler=E,e.debugCompiler=void 0,e.CompilableBlock=b,e.CompilableProgram=v,e.LazyOpcodeBuilder=R,e.EagerOpcodeBuilder=O,e.OpcodeBuilder=k,e.StdOpcodeBuilder=S,e.PartialDefinition=P,e.templateFactory=function(e){var t=e.id,n=e.meta,i=e.block,o=void 0,s=t||"client-"+N++
...
return new Pe(t,n)}(r,a,i)}function Re(e,t,n){return xe(e,t)?new je(n):new Ae(n)}var Oe=function(e){this.attribute=e},Ae=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(e,t){var n,r,i,o=Le(t)
...
n?t.removeAttributeNS(n,this.normalizedName):t.removeAttribute(this.normalizedName)},n}(Oe),Ne=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(t,n,r){var i=this.attribute,o=Ce(r,i.element,i.name,n)
...
return new _(e,t)},e.DOMChanges=fe,e.SVG_NAMESPACE=re,e.IDOMChanges=ce,e.DOMTreeConstruction=de,e.isWhitespace=function(e){return se.test(e)},e.insertHTMLBefore=pe,e.normalizeProperty=Te,e.NewElementBuilder=Ue
e.clientBuilder=function(e,t){return Ue.forInitialRender(e,t)},e.rehydrationBuilder=function(e,t){return _t.forInitialRender(e,t)},e.RehydrateBuilder=_t,e.ConcreteBounds=Q,e.Cursor=$,e.capabilityFlagsFrom=q,e.hasCapability=F}),e("@glimmer/util",["exports","ember-babel"],function(e,t){"use strict"
...
return 2===arguments.length?(n=arguments[0],o=arguments[1],t=null):(t=(e=y.apply(void 0,arguments))[0],n=e[1],void 0===(i=e[2])?o=0:a(o=i.pop())||(r=!0===o,o=i.pop())),[t,n,i,o=parseInt(o,10),r]}var b=0,_=0,w=0,E=0,x=0,C=0,T=0,S=0,k=0,R=0,O=0,A=0,P=0,N=0,j=0,M=0,D=0,L=0,I=0,q=0,F=0,B=function(){function e(e,t){var n=this
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:_,end:w,events:{begin:E,end:0},autoruns:{created:L,completed:I},run:x,join:C,defer:T,schedule:S,scheduleIterable:k,deferOnce:R,scheduleOnce:O,setTimeout:A,later:P,throttle:N,debounce:j,cancelTimers:M,cancel:D,loops:{total:q,nested:F}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
B.Queue=h,e.default=B,e.buildPlatform=i}),e("container",["exports","@ember/debug","@ember/polyfills","ember-owner","ember-utils","@ember/deprecated-features","ember-environment"],function(e,t,n,r,i,o,s){"use strict"
...
var S,k,R,O,A,P,N=(0,i.taggedTemplateLiteralLoose)(["template:components/-default"],["template:components/-default"]),j=(0,i.taggedTemplateLiteralLoose)(["component:-default"],["component:-default"]),M=(0,i.taggedTemplateLiteralLoose)(["template:-root"],["template:-root"]),D=(0,i.taggedTemplateLiteralLoose)(["template-compiler:main"],["template-compiler:main"])
...
function z(e){return new H(e)}function V(e){return(0,u.isArray)(e)?0!==e.length:!!e}var U=(0,l.symbol)("UPDATE"),W=(0,l.symbol)("INVOKE"),G=(0,l.symbol)("ACTION"),Y=function(){function e(){}return e.prototype.get=function(e){return K.create(this,e)},e}(),$=function(e){function t(){var t=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return o.array=t,o}return(0,i.inherits)(t,e),t.from=function(e,t){var n=e.length
return 0===n?Ne:new this(e,n,t)},t.prototype.valueFor=function(e){return(0,c.objectAt)(this.array,e)},t}(Te),Re=function(e){function t(t,n,r,o){var s=(0,i.possibleConstructorReturn)(this,e.call(this,r,o))
...
return e.forEach(function(e,t){(s=s||n.length>=2)&&r.push(t),i.push(e),o++}),0===o?Ne:s?new this(r,i,o,t):new Se(i,o,t)},t.prototype.valueFor=function(e){return this.values[e]},t.prototype.memoFor=function(e){return this.keys[e]},t}(Te),Oe=function(){function e(e,t,n){this.iterable=e,this.result=t,this.keyFor=n,this.position=0}return e.from=function(e,t){var n=e[Symbol.iterator](),r=n.next(),i=r.value
...
var r=this.keyFor()
return Array.isArray(n)?Se.from(n,r):(0,u.isEmberArray)(n)?ke.from(n,r):l.HAS_NATIVE_SYMBOL&&Le(n)?Ae.from(n,r):De(n)?Se.fromForEachable(n,r):Ne},e.prototype.valueReferenceFor=function(e){return new Z(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new Z(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=this.keyPath
...
function Ye(e){return Ue[e]}function $e(e){return null==e?e="":"string"!=typeof e&&(e=""+e),new Ve(e)}function Qe(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}var Ke=void 0,Xe=void 0
...
return r!==e&&(t=cn(this.sourceReference,r),n.inner.update(t.tag),this.innerReference=t,this.lastPath=r),t.value()},n.prototype[U]=function(e){(0,c.set)(this.sourceReference.value(),this.pathReference.value(),e)},n}($),hn=function(e){function t(t,n,r){var o=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return s||(o[t]=T())}function k(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,a.meta)(e):t).writableTag(T):l.CONSTANT_TAG}var R=void 0
...
void 0!==s&&R(s),void 0===i&&void 0===s||C()&&u.backburner.ensureInstance()}R=function(e){e.inner.dirty()}
var A
...
O(e,t,r)}}}o.PROPERTY_DID_CHANGE&&(e.propertyDidChange=D=function(e,t,n){L(e,t,n)})
var I=new Map,q=!0
...
return r(e,"@array:before",t,o),r(e,"@array:change",t,s),a===i&&L(e,"hasArrayObservers"),e}function le(e,t,n,r){_(e,b(t),n,r),ke(e,t)}function ce(e,t,n,r){Oe(e,t),w(e,b(t),n,r)}function pe(e){var t=Y.get(e)
...
i>0&&(r.writeWatching(t,i-1),1===i&&r.writableChains(ve).remove(t))}}function ke(e,t,n){v(t)?Te(e,t,n):W(e,t,n)}function Re(e,t){var n=(0,a.peekMeta)(e)
...
r.get(t)!==Fe&&(r.set(t,Fe),Ae(this,e,t,n))},n.prototype.set=function(e,t,n){return Me(e,this.altKey,n)},n.prototype.readOnly=function(){return this.set=He,this},n.prototype.oneWay=function(){return this.set=ze,this},n}(V)
...
var i=typeof e
return"object"===i&&"number"==typeof(t=ne(e,"size"))?!t:"number"==typeof e.length&&"function"!==i?!e.length:"object"===i&&"number"==typeof(n=ne(e,"length"))&&!n}function Ue(e){return Ve(e)||"string"==typeof e&&!1===/\S/.test(e)}Be.prototype._meta=void 0,Be.prototype.meta=Le.prototype.meta
...
e.isEmpty=Ve,e.isBlank=Ue,e.isPresent=function(e){return!Ue(e)},e.beginPropertyChanges=B,e.changeProperties=z,e.endPropertyChanges=H,e.notifyPropertyChange=L,e.overrideChains=F,e.propertyDidChange=D,e.propertyWillChange=M,e.PROPERTY_DID_CHANGE=P,e.defineProperty=U,e.Descriptor=V,e.watchKey=W,e.unwatchKey=G,e.ChainNode=Ce,e.finishChains=function(e){var t=e.readableChainWatchers()
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(ve)},e.removeChainWatcher=_e,e.watchPath=Te,e.unwatchPath=Se,e.isWatching=function(e,t){return Re(e,t)>0},e.unwatch=Oe,e.watch=ke,e.watcherCount=Re,e.libraries=Ge,e.Libraries=We,e.getProperties=function(e){var t={},n=arguments,r=1
...
return(0,r.setObservers)(o,a),o},e.applyMixin=ft,e.InjectedProperty=yt,e.setHasViews=function(e){C=e},e.tagForProperty=S,e.tagFor=k,e.markObjectAsDirty=O,e.runInTransaction=A,e.didRender=void 0,e.assertNotRendered=void 0,e.descriptor=function(e){return new bt(e)},e.tracked=function(e,t,n){return"value"in n?function(e,t){var n=Symbol(e)
return{enumerable:!0,configurable:!0,get:function(){return Z&&Z.add(S(this,e)),n in this||(this[n]=t.value),this[n]},set:function(t){k(this).inner.dirty(),R(S(this,e)),this[n]=t,ee()}}}(t,n):function(e,t){var n=t.get,r=t.set
...
var f,d
e.MutableArray=e.NativeArray=e.A=void 0,e.isEmberArray=function(e){return e&&e[g]},e.uniqBy=v,e.isArray=T,e.removeAt=R
...
return(0,n.beginPropertyChanges)(),e.forEach(function(e){return t.addObject(e)}),(0,n.endPropertyChanges)(),this}}),A=n.Mixin.create(O,u.default,{objectAt:function(e){return this[e]},replace:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:m
...
return this._super=n,r}return x.add(n),v(n,b(e)),w(n,E(e)),n}var T=Object.prototype.toString,S=Function.prototype.toString,k=Array.isArray,R=Object.keys,O=JSON.stringify,A=100,P=4,N=/^[\w$]+$/
...
break}i=s[r],o+=M(i)+": "+j(e[i],t,n)}return o+=" }"}(e,t+1,n)}function M(e){return N.test(e)?e:O(e)}function D(e,t){return null!=e&&"function"==typeof e[t]}var L=Array.isArray,I=new WeakMap,q=Object.prototype.toString
...
return b(n).apply(r,t)===m&&(i=m.error,m.error=null,C(e,i)),e}function I(e){return null!==e&&"object"==typeof e&&(e.constructor===j||g(e))}function q(e,t){return j.all(e,t)}j.cast=c,j.all=function(e,t){return Array.isArray(e)?new O(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},j.race=function(e,t){var n,r=new this(p,t)
...
if(o&&g.Promise&&(_.promise=new g.Promise(function(e,t){_.resolver=e,_.rejecter=t})),y?(f=arguments[0].properties||arguments[0].p,m=arguments[0].options||arguments[0].o):(f=arguments[a],m=arguments[a+1]),u=c(u)){var w,T=u.length,O=0
...
s&&s.tweensContainer&&(!0===o||""===o)&&p.each(s.tweensContainer,function(e,t){t.endValue=t.currentValue}),N.push(e)}else"finish"!==f&&"finishAll"!==f||(t[2].duration=1)})})}),"stop"===f&&(p.each(N,function(e,t){R(t,!0)}),_.promise&&_.resolver(u)),i()
default:if(!p.isPlainObject(f)||h.isEmptyObject(f)){if(h.isString(f)&&g.Redirects[f]){var j=(e=p.extend({},m)).duration,M=e.delay||0
return!0===e.backwards&&(u=p.extend(!0,[],u).reverse()),p.each(u,function(t,n){parseFloat(e.stagger)?e.delay=M+parseFloat(e.stagger)*t:h.isFunction(e.stagger)&&(e.delay=M+e.stagger.call(n,t,T)),e.drag&&(e.duration=parseFloat(j)||(/^(callout|transition)/.test(f)?1e3:d),e.duration=Math.max(e.duration*(e.backwards?1-t/T:(t+1)/T),.75*e.duration,200)),g.Redirects[f].call(n,n,e||{},t,T,u,_.promise?_:r)}),i()}var D="Velocity: First argument ("+f+") was not a property map, a known action, or a registered redirect. Aborting."
...
if(a.begin&&0===O)try{a.begin.call(u,u)}catch($){setTimeout(function(){throw $},1)}if("scroll"===w){var b,x,C,R=/^x$/i.test(a.axis)?"Left":"Top",A=parseFloat(a.offset)||0
a.container?h.isWrapped(a.container)||h.isNode(a.container)?(a.container=a.container[0]||a.container,C=(b=a.container["scroll"+R])+p(e).position()[R.toLowerCase()]+A):a.container=null:(b=g.State.scrollAnchor[g.State["scrollProperty"+R]],x=g.State.scrollAnchor[g.State["scrollProperty"+("Left"===R?"Top":"Left")]],C=p(e).offset()[R.toLowerCase()]+A),c={scroll:{rootPropertyValue:!1,startValue:b,currentValue:b,endValue:C,unitType:"",easing:a.easing,scrollData:{container:a.container,direction:R,alternateValue:x}},element:e},g.debug&&console.log("tweensContainer (scroll): ",c.scroll,e)}else if("reverse"===w){if(!(d=E(e)))return
...
return h.isFunction(t)&&(t=t.call(e,i,T)),h.isArray(t)?(r=t[0],!h.isArray(t[1])&&/^[\d-]/.test(t[1])||h.isFunction(t[1])||v.RegEx.isHex.test(t[1])?s=t[1]:h.isString(t[1])&&!v.RegEx.isHex.test(t[1])&&g.Easings[t[1]]||h.isArray(t[1])?(o=n?t[1]:S(t[1],a.duration),s=t[2]):s=t[1]||t[2]):r=t,n||(o=o||a.easing),h.isFunction(r)&&(r=r.call(e,i,T)),h.isFunction(s)&&(s=s.call(e,i,T)),[r||0,o,s]},M=function(i,s){var u,l=v.Hooks.getRoot(i),f=!1,m=s[0],b=s[1],_=s[2]
...
var S=0,k=0,R=[],O=[],A=0,P=0,N=0
for(_=v.Hooks.fixColors(_),m=v.Hooks.fixColors(m);S<_.length&&k<m.length;){var j=_[S],M=m[k]
if(/[\d\.-]/.test(j)&&/[\d\.-]/.test(M)){for(var D=j,I=M,q=".",F=".";++S<_.length;){if((j=_[S])===q)q=".."
else if(!/\d/.test(j))break
D+=j}for(;++k<m.length;){if((M=m[k])===F)F=".."
else if(!/\d/.test(M))break
I+=M}var B=v.Hooks.getUnit(_,S),H=v.Hooks.getUnit(m,k)
if(S+=B.length,k+=H.length,B===H)D===I?u+=D+B:(u+="{"+R.length+(P?"!":"")+"}"+B,R.push(parseFloat(D)),O.push(parseFloat(I)))
else{var z=parseFloat(D),V=parseFloat(I)
u+=(A<5?"calc":"")+"("+(z?"{"+R.length+(P?"!":"")+"}":"0")+B+" + "+(V?"{"+(R.length+(z?1:0))+(P?"!":"")+"}":"0")+H+")",z&&(R.push(z),O.push(0)),V&&(R.push(0),O.push(V))}}else{if(j!==M){A=0
break}u+=j,S++,k++,0===A&&"c"===j||1===A&&"a"===j||2===A&&"l"===j||3===A&&"c"===j||A>=4&&"("===j?A++:(A&&A<5||A>=4&&")"===j&&--A<5)&&(A=0),0===P&&"r"===j||1===P&&"g"===j||2===P&&"b"===j||3===P&&"a"===j||P>=3&&"("===j?(3===P&&"a"===j&&(N=1),P++):N&&","===j?++N>3&&(P=N=0):(N&&P<(N?5:4)||P>=(N?4:3)&&")"===j&&--P<(N?5:4))&&(P=N=0)}}S===_.length&&k===m.length||(g.debug&&console.error('Trying to pattern match mis-matched strings ["'+m+'", "'+_+'"]'),u=r),u&&(R.length?(g.debug&&console.log('Pattern found "'+u+'" -> ',R,O,"["+_+","+m+"]"),_=R,m=O,E=x=""):u=r)}if(u||(_=(w=T(i,_))[0],x=w[1],m=(w=T(i,m))[0].replace(/^([+-\/*])=/,function(e,t){return C=t,""}),E=w[1],_=parseFloat(_)||0,m=parseFloat(m)||0,"%"===E&&(/^(fontSize|lineHeight)$/.test(i)?(m/=100,E="em"):/^scale/.test(i)?(m/=100,E=""):/(Red|Green|Blue)$/i.test(i)&&(m=m/100*255,E=""))),/[\/*]/.test(C))E=x
...
for(var D in f)if(f.hasOwnProperty(D)){var q=v.Names.camelCase(D),F=j(f[D])
...
return h.isString(e)?g.Easings[e]||(n=!1):n=h.isArray(e)&&1===e.length?function(e){return function(t){return Math.round(t*e)*(1/e)}}.apply(null,e):h.isArray(e)&&2===e.length?y.apply(null,e.concat([t])):!(!h.isArray(e)||4!==e.length)&&T.apply(null,e),!1===n&&(n=g.Easings[g.defaults.easing]?g.defaults.easing:m),n}function k(e){if(e){var t=g.timestamp&&!0!==e?e:a.now(),n=g.State.calls.length
...
for(var b=Math.min(y/l.duration,1),w=0,x=u.length;w<x;w++){var C=u[w],T=C.element
if(E(T)){var S=!1
if(l.display!==r&&null!==l.display&&"none"!==l.display){if("flex"===l.display){p.each(["-webkit-box","-moz-box","-ms-flexbox","-webkit-flex"],function(e,t){v.setPropertyValue(T,"display",t)})}v.setPropertyValue(T,"display",l.display)}for(var O in l.visibility!==r&&"hidden"!==l.visibility&&v.setPropertyValue(T,"visibility",l.visibility),C)if(C.hasOwnProperty(O)&&"element"!==O){var A,P=C[O],N=h.isString(P.easing)?g.Easings[P.easing]:P.easing
...
if(v.Hooks.registered[O]){D=v.Hooks.getRoot(O)
var L=E(T).rootPropertyValueCache[D]
L&&(P.rootPropertyValue=L)}var I=v.setPropertyValue(T,O,P.currentValue+(o<9&&0===parseFloat(A)?"":P.unitType),P.rootPropertyValue,P.scrollData)
v.Hooks.registered[O]&&(v.Normalizations.registered[D]?E(T).rootPropertyValueCache[D]=v.Normalizations.registered[D]("extract",null,I[1]):E(T).rootPropertyValueCache[D]=I[1]),"transform"===I[0]&&(S=!0)}}l.mobileHA&&E(T).transformCache.translate3d===r&&(E(T).transformCache.translate3d="(0px, 0px, 0px)",S=!0),S&&v.flushTransformCache(T)}}l.display!==r&&"none"!==l.display&&(g.State.calls[i][2].display=!1),l.visibility!==r&&"hidden"!==l.visibility&&(g.State.calls[i][2].visibility=!1),l.progress&&l.progress.call(s[1],s[1],b,Math.max(0,c+l.duration-t),c,d),1===b&&R(i)}}g.State.isTicking&&_(k)}function R(e,t){if(!g.State.calls[e])return!1
...
h.transformCache[t]!==r&&new RegExp("^\\("+n+"[^.]").test(i)&&(f=!0,delete h.transformCache[t])}),o.mobileHA&&(f=!0,delete h.transformCache.translate3d),f&&v.flushTransformCache(c),v.Values.removeClass(c,"velocity-animating")}if(!t&&o.complete&&!o.loop&&u===l-1)try{o.complete.call(i,i)}catch(y){setTimeout(function(){throw y},1)}s&&!0!==o.loop&&s(i),h&&!0===o.loop&&!t&&(p.each(h.tweensContainer,function(e,t){if(/^rotate/.test(e)&&(parseFloat(t.startValue)-parseFloat(t.endValue))%360==0){var n=t.startValue
